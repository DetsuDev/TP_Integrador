...
int main()
{
    ...
    const int enemyCount = 10;
     Enemy *enemies[enemyCount] = { new Rat(), new Rat(), new Rat(), new Rat(), new Rat(),
                                   new Rat(), new Rat(), new Rat(), new Rat(), new Rat() };
    ...
    while (window.isOpen())
    {
        ...
        textEnemies.setString("Enemigos restantes: " + std::to_string(enemyCount));
